...
<div className="container flex flex-col items-start px-3 mx-auto mt-8">
  {cartItems.length === 0 ? (
    ...
    <div className="flex flex-col pt-3 w-full md:w-4/5 lg:w-3/5 xl:w-2/3">
      <h1 className="text-2xl pt-3 font-semibold mb-4">Shopping Cart</h1>

      {cartItems.map((item) => (
        <div key={item._id} className="flex flex-col md:flex-row items-center px-3 mb-4 md:mb-6 pb-2">
