...
const ProductCarousel = () => {
  ...
  return (
    <>
      <h1 className=" text-center text-2xl hidden md:flex flex-col ">
        Featured Product
      </h1>

      <div className="mb-4  hidden md:flex w-[80%] mx-auto   p-4 sm:p-6">
                  ...
                  <div className="border-2 border-gray-200 rounded-xl overflow-hidden hover:border-blue-500 transition-all duration-300 hover:shadow-xl bg-white">
                    <div className="relative">
                      <img
                        src={image}
                        alt={name}
                        className="w-full h-[500px] sm:h-[500px] lg:h-[550px] object-cover object-center hover:scale-105 transition-transform duration-500"
                      />
                    </div>
