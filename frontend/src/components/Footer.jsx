...
const Footer = () => {
  return (
    <footer className="bg-teal-800 text-white mt-4 h-[400px] px-4">
      <div className="container mx-auto flex py-6 px-4 flex-col lg:flex-row justify-between items-start lg:items-center">
        ...
        <div className="mb-4 lg:mb-0">
          ...
          <ul className="text-white">
            ...
            <li><a href="#">How to shop on StoreX?</a></li>
        ...
        <div className="mb-4 lg:mb-0">
          <h2 className="text-lg font-semibold mb-2">ABOUT JUMIA</h2>
          <ul className="text-white">
